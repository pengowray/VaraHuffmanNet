...
namespace VaraHuffman {
    public class VHuffman {
        ...
        public static readonly byte[] HuffmanHeader = new byte[4] { 72, 69, 51, 13 }; // hex: 48-45-33-0D "HE3<CR>" or "HE3\r" (old MacOS line ending)
        ...
        public byte[] EncodeByte(byte[] inputArray, int byteLen = -1, MessageType encoding = MessageType.Auto) {
            ...
            result[0] = HuffmanHeader[0];
            result[1] = HuffmanHeader[1];
            result[2] = HuffmanHeader[2];
            result[3] = HuffmanHeader[3];
            int resultLen = 4;
